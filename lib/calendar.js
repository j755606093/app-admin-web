    ...
    bindEvent: function() {
      ...
      $('.ui-calendar-toolbar', _this.calendarContainer).delegate('a', 'click', function() {
        if ($(this).hasClass('js-calendar-submit')) { //点确定
          // console.log(this);
          if (typeof(_this.dateArr[0]) !== "undefined") {
            ...
            $(_this.settings.target).val(valArr);
          } else {
            _this.dateArr = [];
            _this.date = null;
        ...
        if ($(this).hasClass('ui-calendar-close')) { //点关闭
          // console.log(_this)
          _this.hide();
        }
